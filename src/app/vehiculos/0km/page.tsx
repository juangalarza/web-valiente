...
export default function Vehiculos0KMPage() {
    ...
    <div key={v.id} className="model-card reveal visible">
      ...
      <div className="model-body">
        ...
        <div className="model-foot" style={{ marginTop: 'auto' }}>
          <div>
            <div className="model-label">0KM</div>
      ...
      <section style={{ backgroundColor: 'var(--negro)', paddingTop: '140px', paddingBottom: '60px', textAlign: 'center' }}>
        <div className="section-container">
          ...
          <div style={{ marginTop: '40px', display: 'flex', gap: '8px', justifyContent: 'center', flexWrap: 'wrap' }}>
            ...
            <a href="/vehiculos/0km" style={buttonStyle(true)}>0KM</a>
        ...
        <div className="section-container">
          {loading ? (
            ...
            <div style={{ textAlign: 'center', padding: '100px 20px', color: 'var(--gris-40)', maxWidth: '400px', margin: '0 auto' }}>
              ...
              <h3 style={{ fontSize: '20px', fontWeight: 600, color: 'var(--negro)', marginBottom: '10px' }}>No hay 0KM disponibles</h3>
              <p style={{ lineHeight: 1.6 }}>Pronto habrá unidades 0KM disponibles.<br/>Consultanos por WhatsApp para más información sobre ingresos.</p>
            </div>
          )}
        </div>
      </section>
